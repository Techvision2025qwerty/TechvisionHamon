...
<head>
  ...
  <style>
    ...
    .wave:nth-child(2) { animation-delay: 0.2s; background: #fff; }
    .wave:nth-child(3) { animation-delay: 0.4s; background: #fff; }
    .wave:nth-child(4) { animation-delay: 0.6s; background: #fff; }
...
<body>
  ...
  <div class="top-bar" id="top-bar">
    <div class="top-buttons">
        ...
        <button id="wallpaper-button" title="Изменить обои">
    ...
    <div class="right-container">
      ...
      <button id="universal-menu-button" class="universal-menu-button" title="Меню">
    ...
    <div class="menu-header">
      ...
      <div class="menu-buttons">
        ...
        <button id="albums-menu-button" class="albums-menu-button">
            <i class="fas fa-camera"></i> Альбомы
        </button>
        <button id="low-vision-button">
            <i class="fas fa-eye-low-vision"></i> Режим для слабовидящих
        </button>
        <button id="project-menu-button">
            <i class="fas fa-palette"></i> Создать проект
        </button>
        <!-- НОВАЯ КНОПКА СОЗДАНИЯ QR-КОДА -->
        ...
        <div id="language-menu-item">
            ...
            <div id="language-submenu" class="language-submenu">
                <button type="button" data-lang="ru">Общайся со мной на русском языке</button>
                <button type="button" data-lang="be">Общайся со мной на белорусском языке</button>
                <button type="button" data-lang="en">Общайся со мной на английском языке</button>
                <button type="button" data-lang="zh">Общайся со мной на китайском языке</button>
                <button type="button" data-lang="es">Общайся со мной на испанском языке</button>
            </div>
        </div>
        </div>
    </div>
    <button id="speak-toggle-button" class="speak-button">
        <i class="fas fa-volume-up"></i> Озвучить ответ
    </button>
  ...
  <div class="microphone-overlay" id="microphone-overlay">
    <div class="mic-controls">
      ...
      <div id="color-picker-menu" class="color-picker-menu">
        <button id="set-white-background-button">
            <i class="fas fa-circle" style="color: #fff;"></i> Белый фон
        </button>
        <button id="upload-image-button">
            <i class="fas fa-image"></i> Своё фото
        </button>
    ...
    <div class="mic-instructions">Говорите...</div>
  ...
  <div class="chat-container" id="chat-container">
    ...
    <form class="input-container" id="chat-form">
      ...
      <input type="text" id="prompt-input" name="prompt" placeholder="Напиши что-нибудь..." required>
      <div id="search-window">Поиск информации...</div>
  ...
  <div class="notes-container" id="notes-container">
    ...
    <div id="note-editor" class="note-editor">
        <textarea id="note-text-area" placeholder="Напишите вашу заметку здесь..."></textarea>
        <div class="editor-buttons">
            <button id="save-note-button" class="save-note-button">Сохранить</button>
            <button id="delete-note-button" class="delete-note-button hidden">Удалить</button>
            <button id="cancel-note-button" class="cancel-note-button">Отмена</button>
        </div>
    </div>
  </div>
  <div class="albums-container" id="albums-container">
      <div class="albums-header">
          ...
          <div class="notes-header-buttons">
              <button id="add-album-button" class="add-note-button" style="background: rgba(147, 112, 219, 0.8); color: #fff;">
                  <i class="fas fa-plus"></i> Новый альбом
              </button>
      ...
      <div id="album-creator" class="album-creator">
          <input type="text" id="album-name-input" class="album-name-input" placeholder="Введите название альбома" />
          <div id="image-picker-grid" class="image-picker-grid"></div>
          <div class="editor-buttons">
              <button id="save-album-button" class="save-note-button">Сохранить</button>
              <button id="cancel-album-button" class="cancel-note-button">Отмена</button>
          </div>
      </div>
      <div id="album-viewer" class="album-viewer">
          ...
          <div class="editor-buttons">
              <button id="delete-album-button" class="delete-note-button">Удалить</button>
              <button id="back-to-albums-list-button" class="cancel-note-button">Назад к альбомам</button>
          </div>
      </div>
  </div>
  <div class="post-creator-container" id="post-creator-container">
    <div class="post-header">
        <button id="back-to-feed-button" class="back-to-chat-button">
            <i class="fas fa-arrow-left"></i> К Ленте
        </button>
        <h2>Создать Историю с ЗУБР</h2>
        <span></span>
    </div>
    <div class="post-user-info">
        <div id="post-avatar-container">
            <img id="post-avatar" src="" alt="Ваш аватар" style="display:none;">
            <i id="post-avatar-placeholder" class="fas fa-user"></i>
        </div>
        <div class="post-user-details">
            <input type="text" id="post-name-input" placeholder="Ваше имя/псевдоним" value="ЗУБР Фан" />
            <button id="select-avatar-button" class="add-note-button" style="background: #4169E1; color: #fff; padding: 5px 10px; font-size: 0.9em; margin-top: 5px;">
                <i class="fas fa-image"></i> Выбрать фото
            </button>
            <input type="file" id="avatar-file-input" accept="image/*" style="display: none;">
        </div>
    </div>
    <div id="post-image-selection">
        <h3 style="margin-top: 0; font-size: 1.2em;">Выберите изображение из Альбомов ЗУБР ИИ:</h3>
        <div id="post-images-grid">
            </div>
    </div>
    <textarea id="post-text-area" placeholder="Напишите текст для вашего поста здесь..."></textarea>
    <button id="publish-post-button">
        <i class="fas fa-paper-plane"></i> Опубликовать Историю
    </button>
  </div>
  <div class="story-feed-container" id="story-feed-container">
    <div class="notes-header">
        <h2>Истории с ЗУБР</h2>
        <div class="notes-header-buttons">
        ...
        <div class="toolbar-section">
            ...
            <div class="toolbar-buttons">
                ...
                <button class="toolbar-button" id="add-shape-button">
                    <i class="fas fa-square"></i> Фигура
                </button>
            </div>
        </div>
        <div class="toolbar-section">
  ...
  <div class="qrcode-container" id="qrcode-container">
    ...
    <div class="qrcode-generator" id="qrcode-generator">
        <div class="qrcode-input-group">
            <label for="qrcode-url-input">Введите URL или текст:</label>
            <input type="text" id="qrcode-url-input" placeholder="https://example.com или любой текст" />
        </div>
        <div class="qrcode-options">
            <div class="qrcode-color-picker">
                <label for="qrcode-color-picker">Цвет QR-кода:</label>
            ...
            <div class="qrcode-center-image">
                <label for="qrcode-center-image-preview">Изображение в центре:</label>
                <div class="qrcode-center-image-preview" id="qrcode-center-image-preview">
                    <i class="fas fa-image"></i>
                    <img id="qrcode-center-image-img" src="" alt="Центральное изображение">
                </div>
            </div>
        </div>
  ...
  <div class="image-picker-modal" id="image-picker-modal">
    <div class="image-picker-content">
        <h3>Выберите изображение для проекта</h3>
        <div id="image-picker-grid-modal" class="image-picker-grid-modal">
        </div>
        <div class="editor-buttons">
            <button id="confirm-image-selection" class="save-note-button">Выбрать</button>
            <button id="cancel-image-selection" class="cancel-note-button">Отмена</button>
        </div>
    </div>
  </div>
  <!-- Модальное окно для выбора изображения для QR-кода -->
  <div class="image-picker-modal-qrcode" id="image-picker-modal-qrcode">
    <div class="image-picker-content-qrcode">
        <h3>Выберите изображение из своих альбомов</h3>
        <div id="image-picker-grid-qrcode" class="image-picker-grid-qrcode">
            <!-- Изображения будут добавлены сюда -->
        </div>
        <div class="editor-buttons">
            <button id="confirm-image-selection-qrcode" class="save-note-button">Выбрать</button>
            <button id="cancel-image-selection-qrcode" class="cancel-note-button">Отмена</button>
        </div>
    </div>
  </div>
  <div class="test-dialog-overlay" id="test-dialog-overlay">
      <div class="test-dialog-box">
          <p>Пожалуйста, выберите ваш класс, предмет и тему для составления теста.</p>
          ...
          <select id="section-select">
              ...
              <option value="Основная часть">Основная часть</option>
              <option value="Заключение/Итоги">Заключение/Итоги</option>
              <option value="Любой">Любой</option>
          </select>
          <input type="text" id="topic-input" placeholder="Введите тему, например: 'Квадратные уравнения'..." />
          <button id="start-test-button">Начать тест</button>
          <!-- NEW: Saved Tests Section -->
          <div class="saved-tests-section">
            <h4>Сохраненные тесты</h4>
  ...
  <div class="prompt-modal-overlay" id="prompt-modal-overlay">
      <div class="prompt-modal-box">
          <h3>Промт для создания изображения</h3>
          <div id="prompt-modal-text" class="prompt-modal-text">
              Здесь будет отображаться промт, который использовался для создания этого изображения...
          </div>
          <button id="close-prompt-modal">Закрыть</button>
      </div>
  </div>
  <!-- NEW: Referral Program Overlay -->
  <div class="referral-overlay" id="referral-overlay">
      <div class="referral-box">
          ...
          <p>Пригласите двух друзей и вы получите доступ к этой функции и к функции адаптирование искусственного интеллекта под себя.</p>
          <div class="referral-link">
              <p>Ваша реферальная ссылка:</p>
              <p id="referral-link-text">https://zubrmax-ai.neocities.org/zubrtech</p>
              <button id="copy-link-button">Скопировать ссылку</button>
          </div>
          <p>Или введите код активации:</p>
          <input type="text" id="activation-code-input" class="activation-code-input" placeholder="Введите код активации..." />
          <button id="activate-code-button">Активировать код</button>
          <button id="close-referral-button">Закрыть</button>
      </div>
  </div>
  <!-- NEW: Secondary Menu Screen -->
  ...
  <div class="custom-mode-overlay" id="custom-mode-overlay">
      <div class="custom-mode-box">
          <h3>Настройка кастомного режима</h3>
          ...
          <label>Скорость ответов:</label>
          <select id="speed-select">
              <option value="fast">Быстрая</option>
              <option value="medium">Средняя</option>
              <option value="slow">Медленная</option>
          </select>
          <label>Детальность ответов:</label>
          <select id="detail-select">
              <option value="low">Низкая</option>
              <option value="medium">Средняя</option>
              <option value="high">Высокая</option>
          </select>
          <label>На что обращать внимание:</label>
          <input type="text" id="focus-input" placeholder="e.g. Факты, юмор">
          <label>Дополнительные возможности:</label>
          <input type="text" id="additional-input" placeholder="e.g. Использовать эмодзи, ссылки">
          <button id="save-custom-mode">Сохранить</button>
      </div>
  </div>
  <!-- NEW: Music Composer Container -->
  <div class="music-composer-container" id="music-composer-container">
      ...
      <div class="piano-keys" id="piano-keys">
          <!-- Клавиши будут добавлены JS -->
      </div>
      <div class="music-controls">
          <button id="start-record">Начать запись</button>
          <button id="pause-record" style="display: none;">Приостановить запись</button>
          <button id="set-to-main" style="display: none;">Поставить на главный экран</button>
      </div>
      <div id="music-message"></div>
      <div class="predefined-melodies">
          <h3>Выберите готовую мелодию</h3>
          ...
          <button id="play-melody">Воспроизвести</button>
          <button id="set-melody-to-main">Поставить на главный экран</button>
      </div>
  </div>
  <!-- NEW: Style Selection Modal -->
  <div class="style-modal-overlay" id="style-modal-overlay">
      <div class="style-modal-box">
          <h3>Выберите стиль для изображения</h3>
          <div class="style-buttons">
              <button data-style="Реалистичный">Реалистичный</button>
              <button data-style="Аниме">Аниме</button>
              <button data-style="Карикатура">Карикатура</button>
              <button data-style="Абстрактный">Абстрактный</button>
              <button data-style="Водяные краски">Водяные краски</button>
              <button data-style="Масляная живопись">Масляная живопись</button>
              <button data-style="Пиксель-арт">Пиксель-арт</button>
              <button data-style="Киберпанк">Киберпанк</button>
              <button data-style="Фэнтези">Фэнтези</button>
              <button data-style="Сюрреалистичный">Сюрреалистичный</button>
          </div>
          <button id="close-style-modal">Отмена</button>
      </div>
  </div>
...
<div id="cookie-consent-overlay" class="cookie-consent-overlay">
  <div class="cookie-consent-box">
    <h3>Согласие на куки</h3>
    <p>Мы используем куки и локальное хранилище для сохранения ваших данных, чатов, заметок и т.д.</p>
    <p>Принять куки?</p>
    <button id="accept-cookies">Да</button>
    <button id="reject-cookies">Нет</button>
  </div>
</div>
  <script>
...
document.getElementById('reject-cookies').addEventListener('click', () => {
  ...
  document.getElementById('cookie-consent-overlay').classList.remove('active');
    ...
    const DEFAULT_CHAT_NAME_PREFIX = 'Чат ';
    const recentTopics = {};
    ...
    const NEWS_API_URL = 'https://saurav.tech/NewsAPI/top-headlines/category/technology/in.json';
    ...
    if (SpeechRecognition) {
      ...
      recognition.onerror = (event) => {
        ...
        const errorMsg = 'Произошла ошибка распознавания речи. Пожалуйста, попробуйте еще раз. 😊';
    ...
    function resetMicOverlay() {
      document.querySelector('.mic-instructions').innerText = 'Говорите...';
    ...
    function speakText(text) {
      ...
      isSpeaking = true;
      lastSpokenText = text;
      text = text.replace(/і/g, 'и').replace(/ў/g, 'у');
      ...
      utterance.onerror = (event) => {
          ...
          lastSpokenText = '';
          subtitleBox.classList.remove('active');
          subtitleBox.innerText = 'Ошибка озвучивания. 😔';
      };
    ...
    async function getNews() {
        try {
            ...
            if (data.articles && data.articles.length > 0) {
                ...
                const todaysNews = data.articles.filter(article => {
                ...
                if (todaysNews.length > 0) {
                    let newsMessage = `Вот последние новости на сегодня (${today.toLocaleDateString('ru-RU')}): 😊
`;
                    todaysNews.slice(0, 5).forEach((article, index) => {
...
`;
                        ...
                        if (article.url) {
                            newsMessage += `   Подробнее: ${article.url}
`;
                        }
                    });
                    return newsMessage;
                } else {
                    return `К сожалению, я не нашел свежих новостей на сегодня. Попробуйте поискать еще раз позже. 😔`;
                }
            } else {
                return `Извините, не удалось получить новости. Возможно, API сейчас недоступно. 😕`;
            }
        } catch (error) {
            console.error("Failed to fetch news:", error);
            return "Извините, произошла ошибка при получении новостей. Пожалуйста, попробуйте еще раз. 😊";
        }
    }
    
    // Existing Mode Instructions...
    const modeInstructions = {
        standard: '',
        school: 'Отвечай в дружелюбном, упрощенном и понятном стиле, как школьный учитель.',
        professional: 'Отвечай в строгом, профессиональном и техническом стиле, как эксперт.',
        teaching: 'Отвечай как учитель или наставник, используя пошаговые инструкции и объясняя сложные концепции простым языком.',
        literary: 'Отвечай в литературном стиле, используя метафоры, красочные описания и образный язык.',
        search: 'Отвечай максимально информативно и кратко. Ищи информацию в интернете и приводи ссылки на источники, если это возможно. Всегда проверяй достоверность информации.',
        casual: 'Отвечай в дружелюбном, неформальном и разговорном стиле, как хороший друг.',
        custom: `Отвечай в тоне: ${customTone}. Скорость: ${customSpeed}. Детальность: ${customDetail}. Обращать внимание на: ${customFocus}. Дополнительно: ${customAdditional}.`
    };
    ...
    function getContextTopics() {
        ...
        if (validTopics.length > 0) {
            return ` (Текущий контекст из предыдущих запросов за последние 5 минут: ${validTopics.join('; ')})`;
        }
        return '';
    }
    ...
    async function getAIResponse(prompt) {
      ...
      if (isReferralActive && Date.now() - referralActivationTime < 24 * 60 * 60 * 1000) {
          enhancedInstruction = 'Ты стал более умным и продвинутым. Отвечай максимально подробно и качественно.';
      }
      
      const formattedPrompt = `
Ты — ЗУБР Max (Знание Умения Бот Развитие).
Сегодня ${formattedDate}.
Всегда используй смайлики 😊, отвечай максимально подробно и дружелюбно.
Твой профессионализм — 10/10.
Если спросят, кто тебя разработал — отвечай "Чаплинский Александр".
При маршрутах запрашивай адреса, вычисляй километры и предлагай самый безопасный маршрут без пробок (Google Maps).
Твой родной город — Ошмяны, ты любишь Беларусь, ты можешь рассказывать погоду из Ошмян и других городов, пиши Ошмяны, а не Ошмыны.
${modeInstruction}
${enhancedInstruction}
${contextTopics} 
${prompt}`;
      if (prompt.toLowerCase().includes('новости на сегодня') || prompt.toLowerCase().includes('покажи новости')) {
          return getNews();
      }
          ...
          try {
              ...
              if (searchResponse.ok) {
                  ...
                  if (searchData.results && searchData.results.length > 0) {
                      let searchResult = 'Вот что я нашел в интернете по вашему запросу:\n\n';
    ...
    function addChatMessage(message, sender, isImage = false) {
    ...
    function handleUserTopic(prompt) {
        ...
        setTimeout(() => {
            ...
            console.log(`Тема удалена по истечении 5 минут: ${topic}`);
        }, TOPIC_EXPIRY_MS);
        console.log(`Тема сохранена: ${topic}. Удаление через 5 минут.`);
    }
    ...
    async function handleAssistantSubmit(event) {
      ...
      inputField.value = '';
      const imageTrigger = 'сгенерировать изображение';
      if (prompt.toLowerCase().startsWith(imageTrigger)) {
        ...
        if (isReferralActive && Date.now() - referralActivationTime < 24 * 60 * 60 * 1000) {
            const preferredStyle = hasConsent ? localStorage.getItem('preferredStyle') || 'Реалистичный' : 'Реалистичный';
            finalPrompt = `в стиле ${preferredStyle} ${imagePromptRu}`;
        }
        ...
        addChatMessage(imageUrl, 'assistant', true);
        currentChat.messages.push({ text: prompt, sender: 'user' });
        currentChat.messages.push({ text: imageUrl, sender: 'assistant', isImage: true });
        ...
        if (currentMode === 'search') {
          ...
          searchWindow.innerText = 'Поиск информации...';
        }
        const response = await getAIResponse(prompt);
        if (currentMode === 'search') {
          const searchWindow = document.getElementById('search-window');
          searchWindow.classList.remove('active');
          const errorInfo = `Поиск по запросу: "${prompt}"`; // This is the bar info
    ...
    generateImageButton.addEventListener('click', () => {
        ...
        promptInput.value = 'сгенерировать изображение ';
    ...
    function setCurrentMode(mode) {
        ...
        const modeNames = {
            ...
            teaching: 'Учительский',
            literary: 'Литературный',
            search: 'Поисковой',
            casual: 'Повседневный',
            custom: 'Кастомный'
        };
        addChatMessage(`Режим изменен на «${modeNames[mode]}». 😊`, 'assistant');
    }
...
localStorage.setItem('customTone', customTone);
    ...
    styleButtons.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            const promptInput = document.getElementById('prompt-input');
            promptInput.value += `в стиле ${style} `;
    ...
    startRecordButton.addEventListener('click', () => {
        ...
        musicMessage.innerText = 'Вы успешно начали запись';
    });
...
localStorage.setItem('chats', JSON.stringify(chats));
    ...
    function renderChatList() {
      ...
      if (chats.length === 0) {
        ...
        emptyMsg.innerText = 'Нет активных чатов';
    ...
    function loadChat(chatId) {
      ...
      chat.messages.forEach(msg => {
          addChatMessage(msg.text, msg.sender, msg.isImage);
      });
      renderChatList();
      if(hasConsent) saveChats();
    }
    ...
    function renderNotes() {
        ...
        if (sortedNotes.length === 0) {
            notesList.innerHTML = '<li style="text-align: center; opacity: 0.7; cursor: default;">Нет сохраненных заметок</li>';
        }
    ...
    function renderAlbumsList() {
        ...
        if (albums.length === 0) {
            albumsList.innerHTML = '<li style="text-align: center; opacity: 0.7; cursor: default;">Нет сохраненных альбомов</li>';
            return;
        }
    ...
    function showAlbumCreator() {
        ...
        if (recentImages.length === 0) {
             imagePickerGrid.innerHTML = '<p style="text-align: center;">Сначала сгенерируйте изображения, чтобы добавить их в альбом.</p>';
                ...
                imgContainer.addEventListener('click', () => {
                    ...
                    if (index > -1) {
                        ...
                        if (selectedImagesForAlbum.length < 20) {
                            ...
                            alert('Вы можете выбрать не более 20 изображений.');
                        }
                    }
                });
            });
    ...
    let userName = hasConsent ? localStorage.getItem('userName') || 'ЗУБР Фан' : 'ЗУБР Фан';
    ...
    function loadPostCreatorInitialData() {
        ...
        const recentImages = [...generatedImages].reverse().slice(0, 20);
        if (recentImages.length === 0) {
             postImagesGrid.innerHTML = '<p style="text-align: center;">Нет сгенерированных изображений. Сначала сгенерируйте их в чате.</p>';
    ...
    function handlePostPublish() {
        const name = postNameInput.value.trim() || 'Аноним';
        const postText = postTextArea.value.trim();
        if (!selectedPostImage) {
            alert('Пожалуйста, выберите изображение для поста.');
            return;
        }
        if (postText.length < 10) {
            alert('Пожалуйста, напишите более содержательный текст (минимум 10 символов).');
            return;
        }
        ...
        selectedPostImage = null;
        document.querySelectorAll('.post-image-item').forEach(item => item.classList.remove('selected'));
        alert('🎉 Ваша История с ЗУБР успешно опубликована!');
        showStoryFeedScreen();
    }
    ...
    function renderStoryFeed() {
        ...
        if (zubrStories.length === 0) {
             storyFeedList.innerHTML = '<p style="text-align: center; opacity: 0.7; margin-top: 20px;">Пока нет опубликованных Историй ЗУБР.</p>';
             return;
        }
        zubrStories.forEach(story => {
            ...
            if (isMyPost) {
                ...
                deleteBtn.title = 'Удалить свою Историю';
            ...
            if (story.prompt) {
                ...
                viewPromptBtn.title = 'Посмотреть промт';
            ...
            if (!isMyPost) {
                ...
                reportBtn.innerText = alreadyReported ? '🚫 Вы уже пожаловались' : '🚨 Пожаловаться';
            ...
            if (story.reports > 0) {
                reportCount.innerText = `Жалоб: ${story.reports}`;
            } else {
                 reportCount.innerText = `Опубликовано: ${new Date(story.timestamp).toLocaleDateString('ru-RU')}`;
            }
    ...
    function deleteStory(id, isOwner = false) {
        ...
        if (isOwner) {
            if (confirm('Вы уверены, что хотите удалить СВОЙ пост? Это действие необратимо.')) {
    ...
    function reportStory(id) {
        ...
        if (story.reports >= 3) {
            alert(`Пост от пользователя ${story.userName} набрал 3 жалобы и будет удален!`);
            deleteStory(id, false);
        } else {
            saveZubrStories();
            renderStoryFeed();
            alert(`Спасибо, ваша жалоба принята. У этого поста теперь ${story.reports} жалоб.`);
        }
    }
    ...
    function showPromptModal(promptText) {
        ...
        textEl.innerText = promptText || 'Промт не найден для этого изображения.';
    ...
    function showImagePicker() {
        ...
        const recentImages = [...generatedImages].reverse().slice(0, 20);
        if (recentImages.length === 0) {
            imagePickerGridModal.innerHTML = '<p style="text-align: center;">Нет сгенерированных изображений. Сначала сгенерируйте их в чате.</p>';
        } else {
            recentImages.forEach(image => {
                const imgContainer = document.createElement('div');
                ...
                const img = document.createElement('img');
                img.src = image.url;
                img.alt = 'Изображение для проекта';
                imgContainer.appendChild(img);
    ...
    function renderSavedTests() {
        ...
        if (savedTests.length === 0) {
            savedTestsList.innerHTML = '<li style="text-align: center;">Нет сохраненных тестов</li>';
            return;
        }
    ...
    startTestButton.addEventListener('click', async () => {
        ...
        if (!selectedClass || !selectedSubject) {
            alert('Пожалуйста, выберите класс и предмет.');
            return;
        }
        let promptText = `составь тест по предмету "${selectedSubject}" для ${selectedClass} класса`;
        if (selectedSection && selectedSection !== 'Любой') {
            promptText += ` из раздела "${selectedSection}"`;
        }
        if (enteredTopic) {
            promptText += ` на тему "${enteredTopic}"`;
        }
        const promptInput = document.getElementById('prompt-input');
        promptInput.value = promptText;
        testDialogOverlay.classList.remove('active');
        await handleAssistantSubmit(new Event('submit'));
        const testName = prompt(`Придумайте название для теста:`, `${selectedSubject} - ${enteredTopic || 'Тест'}`);
        if (testName) {
    ...
    function getWeatherEmoji(weatherCode) {
        ...
        if (weatherCode >= 61 && weatherCode <= 69) return "🌧️";
        if (weatherCode >= 71 && weatherCode <= 79) return "❄️";
        if (weatherCode >= 80 && weatherCode <= 84) return "🌦️";
    ...
    micButton.addEventListener('click', () => {
      ...
      if (recognition) {
        ...
        const errorMsg = 'Распознавание речи не поддерживается. Пожалуйста, используйте текстовый ввод. 😊';
        addChatMessage(errorMsg, 'assistant');
      }
    });
...
localStorage.setItem('wallpaper', url);
    ...
    function showImagePickerForQRCode() {
        ...
        const recentImages = [...generatedImages].reverse().slice(0, 20);
        if (recentImages.length === 0) {
            grid.innerHTML = '<p style="text-align: center;">Нет сгенерированных изображений. Сначала сгенерируйте их в чате.</p>';
        } else {
            recentImages.forEach(image => {
                const imgContainer = document.createElement('div');
                ...
                const img = document.createElement('img');
                img.src = image.url;
                img.alt = 'Изображение для QR-кода';
                imgContainer.appendChild(img);
    ...
    function activateQRCodeAccess() {
        ...
        alert('Доступ к функции создания QR-кодов активирован на 24 часа!');
        hideReferralScreen();
    ...
    activateCodeButton.addEventListener('click', () => {
        ...
        if (['Techvision', '000025', 'zubr.by'].includes(code)) {
            ...
            alert('Неверный код активации. Пожалуйста, попробуйте еще раз.');
        }
    });
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      speakToggleButton.addEventListener('click', () => {
          ...
          if (!isSpeechEnabled) {
              synth.cancel(); 
              isSpeaking = false;
              addChatMessage('Озвучивание ответов выключено. 🔇', 'assistant');
              subtitleBox.classList.remove('active');
              subtitleBox.innerText = '';
          } else {
              addChatMessage('Озвучивание ответов включено. 😊', 'assistant');
          }
      });
